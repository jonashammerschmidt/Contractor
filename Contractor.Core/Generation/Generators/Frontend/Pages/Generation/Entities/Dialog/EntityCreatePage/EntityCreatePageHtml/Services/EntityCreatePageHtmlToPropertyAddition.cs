...
{
    public class EntityCreatePageHtmlToPropertyAddition : RelationSideAdditionToExisitingFileGeneration
    {
        ...
        private string GetLine(RelationSide relationSide)
        {
            return
                ...
                $"                            data-testid=\"{relationSide.Entity.Module.NameKebab}-{relationSide.Entity.NameKebab}-create-dialog-{relationSide.NameLower}-dropdown\"></app-search-dropdown-v2>\n" +
                 "                    </div>\n" +
