...
{
    internal class DbEntityDetailTestFromOneToOneAssertAddition : RelationAdditionEditor
    {
        public DbEntityDetailTestFromOneToOneAssertAddition(IFileSystemClient fileSystemClient, PathService pathService)
