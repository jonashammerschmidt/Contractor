...
{
    internal class EntitiesCrudLogicTestsToOneToOneRelationAddition : RelationAdditionEditor
    {
        public EntitiesCrudLogicTestsToOneToOneRelationAddition(IFileSystemClient fileSystemClient, PathService pathService)
