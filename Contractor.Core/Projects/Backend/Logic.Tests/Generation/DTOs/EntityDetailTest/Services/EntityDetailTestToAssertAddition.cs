...
{
    internal class EntityDetailTestToAssertAddition : RelationAdditionEditor
    {
        public EntityDetailTestToAssertAddition(IFileSystemClient fileSystemClient, PathService pathService)
