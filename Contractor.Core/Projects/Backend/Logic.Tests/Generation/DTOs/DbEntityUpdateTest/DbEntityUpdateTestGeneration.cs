...
namespace Contractor.Core.Projects.Backend.Logic.Tests
{
    internal class DbEntityUpdateTestGeneration : ClassGeneration
    {
        ...
        protected override void AddProperty(IPropertyAdditionOptions options)
        {
            ...
            this.logicDbUpdateDtoTestMethodsAddition.Add(options, LogicTestsProjectGeneration.DomainFolder, FileName);
        }
        ...
        protected override void Add1ToNRelation(IRelationAdditionOptions options)
        {
            ...
            this.logicDbUpdateDtoTestMethodsAddition.Add(propertyAdditionOptions, LogicTestsProjectGeneration.DomainFolder, FileName);
        }
