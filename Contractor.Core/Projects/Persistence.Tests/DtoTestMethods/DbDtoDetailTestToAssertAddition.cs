...
namespace Contractor.Core.Projects
{
    internal class DbDtoDetailTestToAssertAddition
    {
        ...
        private string UpdateFileData(IRelationAdditionOptions options, string filePath)
        {
            ...
            fileData = UsingStatements.Add(fileData, $"{options.ProjectName}.Contract.Persistence.Model.{options.DomainFrom}.{options.EntityNamePluralFrom}");
            fileData = UsingStatements.Add(fileData, $"{options.ProjectName}.Persistence.Tests.Model.{options.DomainFrom}.{options.EntityNamePluralFrom}");
