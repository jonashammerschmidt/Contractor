...
namespace Contractor.Core.Projects.Frontend.Pages
{
    internal class EntityDetailPageTsGeneration : ClassGeneration
    {
        ...
        private static readonly string FileName = "sub-pages\\entity-kebab-detail\\entity-kebab-detail.page.ts";
        ...
        {
            this.entityDetailPageTsFromPropertyAddition.Add(options, PagesProjectGeneration.DomainFolder, FileName);
        }
