...
{
    internal class FrontendDtoPropertyFromOneToOneMethodAddition
    {
        public PathService pathService;

        public FrontendDtoPropertyFromOneToOneMethodAddition(PathService pathService)
        {
        ...
        private string UpdateFileData(IRelationAdditionOptions options, string filePath)
        {
            ...
            stringEditor.InsertLine($"            {options.PropertyNameTo.LowerFirstChar()}: {options.EntityNameTo}.fromApi{options.EntityNameTo}(api{options.EntityNameFrom}Detail.{options.PropertyNameTo.LowerFirstChar()}),");
